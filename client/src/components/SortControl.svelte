<script lang="ts">
    ...
    function touch_start({ pointerType }: PointerEvent) {
...
<div bind:this={container} class="bg-white rounded-full relative min-w-[40px] h-[76px] overflow-hidden hover:overflow-visible" on:pointerdown={touch_start}>
