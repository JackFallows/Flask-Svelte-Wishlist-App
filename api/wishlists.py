...
def get_wishlist(wishlist_id):
    ...
    if current_user.id != wishlist.user_id:
        bought_items = list(map(lambda bi: bi.as_dict(current_user.id), BoughtItem.get_for_wishlist(wishlist_id)))
    else:
        bought_items = list(map(lambda bi: bi.as_dict(current_user.id), BoughtItem.get_for_wishlist_owner(wishlist_id, current_user.id)))
